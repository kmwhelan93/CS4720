...
<head>
	...
	<!-- SPECIFIC JS & CSS -->
	<script type="text/javascript" src="../../js/priority.js" async ></script>
...
<div class="navbar-header">
  ...
  <ul class="nav navbar-nav navbar-right">
    <li class="active"><a href="../../home.php">Hi, <?php echo $_SESSION['username'] ?></a></li>
...
<span id="priority" style="display:none"><?php echo "$priority"; ?></span>
<div class="container">
